  ...
  return (
    <div className="w-full md:w-1/3 md:h-full flex relative">
      <button
        ...
        className={`absolute z-2 flex h-full flex-col justify-between items-start cursor-pointer bg-color-two/30 py-4 px-4 ${isHovered ? 'w-auto' : 'w-12'} transition-all duration-300 ease-in-out`} //FIXME - bug transition-all duration-300 ease-in-out
